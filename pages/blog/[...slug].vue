                        ...
                        <div
                            ...
                            <aside class="flex flex-row items-center justify-center mx-4 sm:mx-0 lg:pl-0">
                                ...
                                <footer class="w-3/4 mx-4">
                                    <div class="">
                                        <NuxtLink :to="doc.authorUrl" class="font-semibold text-[#242424] dark:text-white">
                                            {{ doc.author }}
                                        </NuxtLink>
                                    </div>
                    ...
                    <Section id="main">
                        <div class="flex flex-row items-center justify-center">
                            <div class="flex flex-col items-center justify-center gap-12">
                                <!-- artikel about me  -->
                                <article
                                    class="mx-4 text-base font-normal prose sm:mx-0 contianer lg:pl-0 text-primary dark:text-secondary">
                                    <!-- Update date -->
