...
<template>
  ...
  >
    ...
    >
      <div class="">
        <h1
          class="text-3xl font-bold text-transparent bg-gradient-to-r bg-clip-text from-[#DC79FF] to-[#256BFA]"
        >
          {{ title }}
        </h1>
      </div>
    ...
    <div class="flex flex-row items-center justify-between">
      <Icon
        ...
        class="text-[#4A576F]/40 rounded dark:text-white/40"
        size="3rem"
      />
      <span
        class="text-xs font-medium text-[#4A576F]/70 mx-2 dark:text-white/60"
      >
        ✦
      </span>
      <Icon
    ...
    <div class="flex flex-col items-center justify-center pt-28">
      ...
      <h1
        class="pt-4 font-semibold text-xs uppercase text-[#4A576FB2]/70 dark:text-white/70"
      >
        WHAT'S ON MY DESK
      </h1>
    </div>
